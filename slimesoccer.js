...
Player.prototype.update = function()
{
	...
	if(this.playerNumber==2)
	{
	  ...
	  if(Key.isDown(Key.W) && !this.isGoingUp)
	  {
	  	this.velY=-15;
	  	this.isGoingUp=1;
	  }
...
Ball.prototype.update = function()
{
	...
	if(this.x<this.bbox.minX)
	{
		this.x=this.bbox.minX; 
		stopX=1;
	}
	//right boundary
	if(this.x>=this.game.width-this.bbox.maxX)
	{
		this.x=this.game.width-this.bbox.maxX; 
		stopX=1;
	}
	//up boundary
	if(this.y<=this.bbox.minY)
	{
		this.y=this.bbox.minY; 
		stopY=1;
	}
	//down boundary
	if(this.y>this.game.height-this.bbox.maxY)
	{
		this.y=this.game.height-this.bbox.maxY; 
		stopY=1;
	}
